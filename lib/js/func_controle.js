...
{   
    ...
    //mostrar exercicio
    $(document).on('click', '.botao_mostrar_exercicio, .salvar_exercicio', function(){
    ...
    //excluir exercicio
    $(document).on('click', '.botao_excluir_exercicio', function(){

        let qtd_exercicio = $("#quantidade_exercicio").val();
        let id = $(this).closest('[data-id]');

        $("#"+id.data('id')).remove();
        $("#quantidade_exercicio").val(qtd_exercicio - 1);
        contator_exercicio = contator_exercicio - 1;
                ...
                success: function(response){
                    ...
                    for(let i = 0; i < response.total; i++)
                    {
                        $(".select_exercicio").append(
                            "<option value='"+response.id[i]+ "-" +response.tipo[i] + "-" +response.id_grupo[i] +"'>"+response.nome[i]+"</option>");
                    }
                }
            });
        });
    ...
    $(".adicionar_exercicio").click(function(){
        ...
        {   
                    ...
                    "<div class='nome_exercicio'>"+
                        ...
                        "<div class='campos_tres'>"+
                            ...
                            "<div class='divisao_campo'>"+
                                ...
                                "<input type='text' class='campo_sistema' name='carga["+contator_exercicio+"]' id='velocidade"+contator_exercicio+"' maxlength='10'>"+
                            "</div>"+
                        "</div>"+
                        "<div class='base_exercicio'>"+
                            "<button type='button' class='botao excluir_botao botao_vermelho botao_excluir_exercicio' name='excluir["+contator_exercicio+"]'>Excluir</button>"+
                            "<button type='button' class='botao botao_azul salvar_exercicio' name='salvar["+contator_exercicio+"]'>Salvar</button>"+
                        "</div>"+
                    "</div>"+
                "</div>"+

                "<input type='hidden' name='grupo_muscular["+contator_exercicio+"]' id='grupo_muscular"+contator_exercicio+"' value='"+id_grupo+"'>"+
                "<input type='hidden' name='exercicio["+contator_exercicio+"]' id='exercicio"+contator_exercicio+"' value='"+id+"'>"+
                "<input type='hidden' name='tipo["+contator_exercicio+"]' id='tipo"+contator_exercicio+"' value='"+nome+"'>";
            }
            // Box funcional
                    ...
                    "<div class='nome_exercicio'>"+
                        ...
                        "<div class='campos_tres'>"+
                            "<div class='divisao_campo'>"+
                                ...
                                "<input type='text' class='campo_sistema' name='serie["+contator_exercicio+"]' id='serie_"+contator_exercicio+"' maxlength='20'>"+
                            "</div>"+

                            "<div class='divisao_campo'>"+
                                "<label class='label_sistema'>Repetições</label>"+
                                "<input type='text' class='campo_sistema' name='repeticao["+contator_exercicio+"]' id='repeticao_"+contator_exercicio+"' maxlength='10'>"+
                            "</div>"+

                            "<div class='divisao_campo'>"+
                                "<label class='label_sistema'>Carga</label>"+
                                "<input type='text' class='campo_sistema' name='carga["+contator_exercicio+"]' id='carga_"+contator_exercicio+"'>"+
                            "</div>"+

                            "<div class='divisao_campo'>"+
                                "<label class='label_sistema'>Descanso</label>"+
                                "<input type='text' class='campo_sistema' name='descanso["+contator_exercicio+"]' id='descanso_"+contator_exercicio+"' maxlength='10'>"+
                            "</div>"+
                        "</div>"+
                        "<div class='base_exercicio'>"+
                            "<button type='button' class='botao excluir_botao botao_vermelho botao_excluir_exercicio' name='excluir["+contator_exercicio+"]'>Excluir</button>"+
                            "<button type='button' class='botao botao_azul salvar_exercicio salvar_exercicio' name='salvar["+contator_exercicio+"]'>Salvar</button>"+
                        "</div>"+
                    "</div>"+
                "</div>"+
                ...
                "<div class='box_exercicio' data-id='"+nome+ "_" +contator_exercicio+"' id='"+nome+ "_" +contator_exercicio+"'>"+
                    ...
                    "<div class='nome_exercicio'>"+
                        ...
                        "<div class='campos_tres'>"+
                            "<div class='divisao_campo'>"+
                                "<label class='label_sistema'>Tempo</label>"+
                                "<input type='text' class='campo_sistema' name='tempo["+contator_exercicio+"]' id='tempo_"+contator_exercicio+ "'>"+
                            "</div>"+

                            "<div class='divisao_campo'>"+
                                "<label class='label_sistema'>Velocidade</label>"+
                                "<input type='text' class='campo_sistema' name='velocidade["+contator_exercicio+"]' id='velocidade_"+contator_exercicio+ "'>"+
                            "</div>"+
            ...
            $("#quantidade_exercicio").val(contator_exercicio);
        }
